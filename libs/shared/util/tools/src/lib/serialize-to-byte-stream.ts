...
import { serialize as serializeToByteStream } from 'php-serialize'
 ...
 *
 * @see {@link unserializeFromByteStream}
 ...
 * @inheritDoc
 */
export { serializeToByteStream }
export default serializeToByteStream
