...
export interface JsonModalProps extends Omit<DialogProps, 'defaultValue'> {
  defaultValue?: iJSON
  onSave?: {
...
function JsonModal(props: JsonModalProps) {
  ...
  const handleClose: JsonModalProps['onClose'] = useCallback(
    (event, reason) => {
